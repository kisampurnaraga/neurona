...
async function run() {
  ...
  try {
    ...
    console.log('URL browser SEBELUM OpenArt =', process.env.APP_URL || 'https://ais-dev-lhwcbpgrrfalopwm3dt5h2-654788409683.asia-southeast1.run.app');
    console.log('URL OpenArt authorization =', data.authUrl);
    console.log('redirect_uri yang dikirim =', data.redirectUri);
    console.log('URL setelah Allow =', data.redirectUri);
