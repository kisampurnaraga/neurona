...
const replacement = `  // Handle local file upload for frame override
  const resizeImageFile = (file: File, maxWidth = 800, maxHeight = 800, quality = 0.7): Promise<string> => {
...
const original = `  // Handle local file upload for frame override
