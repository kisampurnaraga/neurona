...
// Model option lists live in a shared module so App.tsx can use them without
// statically importing this large modal. Re-exported here for compatibility.
import { IMAGE_MODEL_OPTIONS, VIDEO_MODEL_OPTIONS, type ImageModelId } from '../shared/modelOptions';
export type { ImageModelId, ImageModelOption, VideoModelOption } from '../shared/modelOptions';
export { IMAGE_MODEL_OPTIONS, VIDEO_MODEL_OPTIONS } from '../shared/modelOptions';
