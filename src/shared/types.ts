export type ProductionState = 'DRAFT' | 'BRIEFING' | 'STORYBOARDING' | 'QUOTA_FALLBACK_PENDING' | 'AWAITING_APPROVAL' | 'PRODUCING' | 'ASSEMBLING' | 'AUDIO' | 'EDITING' | 'QA' | 'COMPLETED' | 'FAILED' | 'deleted' | 'PROCESSING';
